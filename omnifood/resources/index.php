...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="Omnifood, Healthy, Meals">
    ...
    <body>
        <header id="up">
          <nav>
              <div class="row">
                  <a href="#up"><img src="resources/img/logo-white.png" alt="Omnifood logo" class="logo"></a>
                  <a href="#up"><img src="resources/img/logo.png" alt="Omnifood logo" class="logo-black"></a>
        ...
        <section class="section-testimonials">
           ...
           <div class="row">
               ...
               <blockquote>
                   ...
                   <cite><img src="resources/img/customer-1.jpg" alt="Picture of a customer">Alberto Duncan</cite>
               </blockquote>
               </div>
               <div class="col span-1-of-3">
               <blockquote>
                   Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
                   <cite><img src="resources/img/customer-2.jpg" alt="Picture of a customer">Joana Silva</cite>
               </blockquote>
               </div>
               <div class="col span-1-of-3">
               <blockquote>
                   I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                   <cite><img src="resources/img/customer-3.jpg" alt="Picture of a customer">Milton Chapman</cite>
               </blockquote>
               </div>
           </div>
    ...
    <script src="//cdn.jsdelivr.net/npm/selectivizr@1.0.3/selectivizr.js"></script>
